...
const DAY_DETAILS = {
  ...
  51: { grammar: "je voudrais / j'aimerais", vocab: "Révision émotions & opinions", tables: [CONJUGATIONS.condChunks], prompt: "Utilise « je voudrais » et « j'aimerais » dans deux phrases sur ce que tu veux faire bientôt.", sentences: SENTENCES[51] },
  52: { grammar: "tu pourrais / est-ce que tu pourrais", vocab: "Révision émotions & opinions", tables: [CONJUGATIONS.condChunks], prompt: "Transforme une demande directe en demande adoucie : « Fais ça » → « Tu pourrais faire ça ? ».", sentences: SENTENCES[52] },
  53: { grammar: "ça serait + révision des formules d'adoucissement", vocab: "d'accord, pas d'accord, sûr(e), peut-être", tables: [CONJUGATIONS.condChunks], prompt: "Utilise « ça serait » dans une phrase : « Ça serait bien de... ».", sentences: SENTENCES[53] },
  54: { grammar: "Désaccord & réparation : pas d'accord, ce n'est pas grave, on peut en parler", vocab: "Révision libre", tables: [CONJUGATIONS.condChunks], prompt: "Pratique : « Je ne suis pas d'accord, mais... » suivi de « Ce n'est pas grave » ou « On peut en parler ».", sentences: SENTENCES[54] },
  55: { grammar: "Checkpoint du bloc : adoucis 3 demandes réelles + 1 désaccord", vocab: "Révision de tout le bloc 5", tables: [CONJUGATIONS.condChunks], prompt: "Adoucis trois demandes réelles et pratique un désaccord avec réparation.", sentences: SENTENCES[55] },

  56: { grammar: "Aucune nouvelle structure — monologue intégrant présent, passé composé, futur proche, conditionnel", vocab: "Révision générale", tables: [], prompt: "Enregistre un monologue de deux minutes intégrant présent, passé composé, futur proche et une formule au conditionnel.", sentences: SENTENCES[56] },
  57: { grammar: "Vraie conversation de 10+ minutes, sans anglais pendant les 5 premières minutes", vocab: "Révision générale", tables: [], prompt: "Vraie conversation de dix minutes ou plus, sans anglais pendant les cinq premières minutes.", sentences: SENTENCES[57] },
  58: { grammar: "Compare ton enregistrement du Jour 20 à aujourd'hui", vocab: "Révision générale", tables: [], prompt: "Réécoute ton enregistrement du Jour 20 — qu'est-ce qui a changé depuis ?", sentences: SENTENCES[58] },
  59: { grammar: "Réparation ciblée des 3 points qui te bloquent encore", vocab: "Révision générale", tables: [], prompt: "Reprends les trois points qui te bloquent encore et entraîne-toi uniquement sur ceux-là.", sentences: SENTENCES[59] },
  60: { grammar: "Monologue final + vraie conversation — compare au Jour 1", vocab: "Révision générale", tables: [], prompt: "Monologue final, puis vraie conversation — compare au tout premier jour.", sentences: SENTENCES[60] }
};
