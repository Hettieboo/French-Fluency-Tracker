...
const DAY_DETAILS = {
  ...
  2: { grammar: "avoir (au présent)", vocab: "Pronoms compléments (moi, toi, lui) + possessifs (mon/ma/mes, ton/ta/tes)", vocabWords: ["moi", "toi", "lui", "mon/ma/mes", "ton/ta/tes"], vocabExamples: [["J'ai confiance en toi.", "I trust you."], ["Tu as mes clés ?", "Do you have my keys?"], ["Il a ton stylo, pas moi.", "He has your pen, not me."], ["Elle a ma confiance.", "She has my trust."], ["Nous avons ton adresse.", "We have your address."], ["Vous avez raison, pas lui.", "You're right, not him."], ["Ils ont mon numéro.", "They have my number."]], tables: [CONJUGATIONS.avoir], prompt: "Dis trois phrases avec avoir : « J'ai... », « Tu as... », « Il/elle a... ». Par exemple : « J'ai un frère. »" },
  3: { grammar: "Révision : être + avoir ensemble", vocab: "Possessifs (son/sa/ses, notre, votre, leur)", vocabWords: ["son/sa/ses", "notre", "votre", "leur"], vocabExamples: [["Sa sœur est drôle.", "His/her sister is funny."], ["Son père a raison.", "His/her father is right."], ["Notre maison est petite.", "Our house is small."], ["Notre famille a une grande maison.", "Our family has a big house."], ["Votre famille est grande.", "Your family is big."], ["Leur fille est fatiguée.", "Their daughter is tired."]], tables: [CONJUGATIONS.etre, CONJUGATIONS.avoir], prompt: "Combine être et avoir dans une seule phrase, par exemple : « Je suis fatigué(e) et j'ai faim. » Essaie avec ta propre situation." },
  4: { grammar: "faire (au présent)", vocab: "Famille proche : maman, papa, frère, sœur, fils, fille", vocabWords: ["maman", "papa", "frère", "sœur", "fils", "fille"], vocabExamples: [["Je fais le dîner.", "I'm making dinner."], ["Tu fais la vaisselle.", "You're doing the dishes."], ["Papa fait la cuisine.", "Dad is cooking."], ["Maman fait le café.", "Mom is making coffee."], ["Mon frère fait ses devoirs.", "My brother is doing his homework."], ["Nous faisons une promenade avec ma sœur.", "We're going for a walk with my sister."], ["Vous faites une surprise à votre fille ?", "Are you surprising your daughter?"], ["Mon fils et ma fille font leurs devoirs ensemble.", "My son and daughter are doing homework together."]], tables: [CONJUGATIONS.faire], prompt: "Dis ce que tu fais en ce moment avec faire : « Je fais... », « Tu fais... », « Il/elle fait... »." },
  5: { grammar: "aller (au présent)", vocab: "Famille : mari, femme, copain, copine, enfant, bébé", vocabWords: ["mari", "femme", "copain/copine", "enfant", "bébé"], vocabExamples: [["Je vais au marché.", "I'm going to the market."], ["Tu vas chez ton copain ?", "Are you going to your boyfriend's place?"], ["Mon mari va à la maison.", "My husband is going home."], ["Ma femme va au marché avec le bébé.", "My wife is going to the market with the baby."], ["Nous allons chez mes parents.", "We're going to my parents' place."], ["Vous allez chez votre copine ?", "Are you going to your girlfriend's place?"], ["Les enfants vont au parc avec le bébé.", "The kids are going to the park with the baby."]], tables: [CONJUGATIONS.aller], prompt: "Dis où tu vas avec aller : « Je vais... », « Tu vas... », « Il/elle va... »." },
  6: { grammar: "Révision : faire + aller", vocab: "Belle-famille : beau-père, belle-mère, beau-frère, belle-sœur, grands-parents", vocabWords: ["beau-père/belle-mère", "beau-frère/belle-sœur", "grands-parents"], vocabExamples: [["Mon beau-père fait le café.", "My father-in-law is making coffee."], ["Ma belle-mère va au marché.", "My mother-in-law is going to the market."], ["Mon beau-frère fait la cuisine.", "My brother-in-law is cooking."], ["Ma belle-sœur va chez mes parents.", "My sister-in-law is going to my parents' place."], ["Mes grands-parents font une promenade.", "My grandparents are going for a walk."], ["Nous allons chez mes grands-parents.", "We're going to my grandparents' place."], ["Vous faites quoi avec vos beaux-parents ?", "What are you doing with your in-laws?"]], tables: [CONJUGATIONS.faire, CONJUGATIONS.aller], prompt: "Réponds : « Qu'est-ce que tu fais ce soir ? Où est-ce que tu vas après ? » (utilise faire et aller)." },
  7: { grammar: "pouvoir (au présent)", vocab: "Émotions de base : content(e), heureux/heureuse, triste, fâché(e)", vocabWords: ["content(e)", "heureux/heureuse", "triste", "fâché(e)"], vocabExamples: [["Je peux être content aujourd'hui.", "I can be happy today."], ["Tu peux être heureux avec moi.", "You can be happy with me."], ["Il peut être triste aujourd'hui.", "He can be sad today."], ["Elle peut être fâchée aussi.", "She can be angry too."], ["Nous pouvons être heureux ensemble.", "We can be happy together."], ["Vous pouvez être contents aujourd'hui.", "You can be happy today."], ["Ils peuvent être tristes aussi.", "They can be sad too."]], tables: [CONJUGATIONS.pouvoir], prompt: "Dis ce que tu peux faire avec pouvoir : « Je peux... », « Tu peux... », « Il/elle peut... »." },
  8: { grammar: "vouloir (au présent)", vocab: "Émotions : fatigué(e), stressé(e), surpris(e), fier/fière, gêné(e)", vocabWords: ["fatigué(e)", "stressé(e)", "surpris(e)", "fier/fière", "gêné(e)"], vocabExamples: [["Je veux être fier de toi.", "I want to be proud of you."], ["Tu veux être fier, pas gêné.", "You want to be proud, not embarrassed."], ["Il veut être content, pas fatigué.", "He wants to be happy, not tired."], ["Elle veut être surprise par toi.", "She wants to be surprised by you."], ["Nous voulons être fiers de nos enfants.", "We want to be proud of our kids."], ["Vous voulez être fiers de la famille.", "You want to be proud of the family."], ["Ils veulent être surpris.", "They want to be surprised."]], tables: [CONJUGATIONS.vouloir], prompt: "Dis ce que tu veux faire avec vouloir : « Je veux... », « Tu veux... », « Il/elle veut... »." },
  9: { grammar: "Révision pouvoir + vouloir, et le patron régulier des verbes en -er", vocab: "d'accord, pas d'accord, peut-être, vraiment", vocabWords: ["d'accord", "pas d'accord", "peut-être", "vraiment"], vocabExamples: [["D'accord, je peux faire ça.", "Okay, I can do that."], ["Tu veux vraiment parler de ça ?", "Do you really want to talk about that?"], ["Il peut parler un peu français.", "He can speak a little French."], ["Elle veut peut-être rester à la maison.", "Maybe she wants to stay home."], ["Nous pouvons regarder un film ensemble.", "We can watch a movie together."], ["Vous voulez manger avec nous ?", "Do you want to eat with us?"], ["Ils ne sont pas d'accord, mais ils peuvent essayer.", "They disagree, but they can try."]], tables: [CONJUGATIONS.pouvoir, CONJUGATIONS.vouloir, CONJUGATIONS.parlerEr], prompt: "Utilise pouvoir, vouloir et un verbe en -er (comme parler) dans une phrase : « Je veux parler français » ou « Tu peux regarder ça ? »." },
