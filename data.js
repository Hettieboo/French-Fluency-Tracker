...
const BLOCKS = [
  ...
  },
  {
    ...
    grammar: "Aucune nouvelle structure — intégration de présent, passé composé, futur proche, impératif, conditionnel",
  ...
  },
  {
    range: [69, 70],
    color: "#8e44ad",
    title: "Bilan final — l'histoire d'Élise",
    grammar: "Aucune nouvelle structure — test de compréhension (lecture des 5 chapitres) et de fluidité (conversation finale) après le cours complet",
    vocabFocus: "Tout le vocabulaire du cours",
    prompts: [
      "Lis les 5 chapitres de l'histoire et résume-la avec tes propres mots.",
      "Quelles leçons est-ce qu'Élise apprend dans l'histoire ?",
      "Vraie conversation de 10+ minutes sur l'histoire, sans anglais.",
      "Monologue final — compare-le à celui du Jour 1."
    ]
  }
];
...
const DAY_DETAILS = {
  ...
  21: { grammar: "Passé composé avec avoir — verbes réguliers en -er", vocab: "Maison : maison, appartement, chambre, cuisine, salon", vocabWords: ["maison", "appartement", "chambre", "cuisine", "salon"], vocabExamples: [["J'ai parlé avec ma sœur dans la cuisine.", "I talked with my sister in the kitchen."], ["J'ai mangé dans l'appartement.", "I ate in the apartment."], ["J'ai regardé la chambre.", "I looked at the bedroom."], ["J'ai travaillé dans le salon.", "I worked in the living room."], ["Nous avons habité dans cette maison.", "We lived in this house."], ["Tu as écouté de la musique dans le salon.", "You listened to music in the living room."], ["Il a aimé la nouvelle maison.", "He liked the new house."]], didYouNotice: "Passé composé is always two pieces: the helper (avoir, conjugated: j'ai, tu as, il a...) plus a participle (what happened: parlé, mangé...). For -er verbs the participle is predictable — drop -er, add -é — but you'll meet verbs on Day 22 where the participle doesn't follow this pattern at all.", tables: [{ title: "Passé composé = avoir (conjugué) + participe passé", rows: CONJUGATIONS.avoir.rows, note: "Regular -er verbs have predictable past participles. The verb after avoir is never the infinitive. For regular -er verbs, simply replace -er with -é: parler → parlé, manger → mangé." }], participleLesson: { intro: "A past participle is a special form of a verb used after avoir (or être) to talk about completed actions. It is not the infinitive.", pairs: [["parler", "parlé", "to speak"], ["manger", "mangé", "to eat"], ["regarder", "regardé", "to watch/look"], ["aimer", "aimé", "to like/love"], ["écouter", "écouté", "to listen"], ["travailler", "travaillé", "to work"], ["habiter", "habité", "to live (somewhere)"]], helperExamples: [["j'ai", "parlé"], ["tu as", "parlé"], ["il a", "parlé"]], examplePairs: [["J'ai parlé.", "J'ai parler."]] }, prompt: "Raconte ce que tu as fait aujourd'hui avec des verbes en -er : « J'ai parlé avec... », « J'ai mangé... ».", promptEn: "Talk about what you did today using -er verbs: « J'ai parlé avec... », « J'ai mangé... »." },
  22: { grammar: "Passé composé avec avoir — participes irréguliers", vocab: "travail, voiture, téléphone, argent, temps", vocabWords: ["travail", "voiture", "téléphone", "argent", "temps"], vocabExamples: [["J'ai eu beaucoup de travail.", "I had a lot of work."], ["J'ai pris la voiture.", "I took the car."], ["J'ai mis mon téléphone là.", "I put my phone there."], ["J'ai eu besoin d'argent.", "I needed money."], ["J'ai eu peu de temps.", "I had little time."], ["Tu as vu la nouvelle voiture ?", "Did you see the new car?"], ["Elle a fait beaucoup de travail aujourd'hui.", "She did a lot of work today."]], didYouNotice: "Passé composé always has two parts: the helper (avoir, conjugated: j'ai, tu as, il a...) and the past participle (the special verb form that describes the completed action). The verb after the helper is never the infinitive — you can't skip the participle, and you can't double avoir (\"j'ai avoir\" doesn't exist).", tables: [{ title: "Passé composé = avoir (conjugué) + participe passé", rows: CONJUGATIONS.avoir.rows, note: "Every verb has its own past participle. Regular -er verbs follow the pattern -er → -é, but irregular verbs must be learned individually: faire → fait, avoir → eu, prendre → pris. Remember: after avoir, you always use the past participle, never the infinitive." }], participleLesson: { intro: "Irregular verbs don't follow the -er → -é pattern — each one has its own past participle that has to be learned individually.", pairs: [["faire", "fait", "to do/make"], ["avoir", "eu", "to have"], ["prendre", "pris", "to take"], ["mettre", "mis", "to put"], ["dire", "dit", "to say"], ["voir", "vu", "to see"]], helperExamples: [["j'ai", "fait"], ["j'ai", "eu"], ["j'ai", "pris"]], examplePairs: [["J'ai fait.", "J'ai faire."], ["J'ai eu.", "J'ai avoir."]] }, prompt: "Utilise j'ai fait, j'ai eu, j'ai pris, j'ai mis, j'ai dit ou j'ai vu — choisis-en trois et fais une phrase avec chacun.", promptEn: "Use j'ai fait, j'ai eu, j'ai pris, j'ai mis, j'ai dit, or j'ai vu — pick three and make a sentence with each." },
  23: { grammar: "Révision : poser des questions au passé composé", vocab: "jour, semaine, week-end, matin, soir, nuit", vocabWords: ["jour/semaine/week-end", "matin/soir/nuit"], vocabExamples: [["Qu'est-ce que tu as fait ce jour-là ?", "What did you do that day?"], ["J'ai dormi tout le matin.", "I slept all morning."], ["Tu as travaillé toute la semaine ?", "Did you work all week?"], ["Il a dormi tout le week-end.", "He slept all weekend."], ["Elle a parlé tout le soir.", "She talked all evening."], ["Nous avons travaillé toute la nuit.", "We worked all night."]], tables: [{ title: "Passé composé = avoir (conjugué) + participe passé", rows: CONJUGATIONS.avoir.rows }], prompt: "Demande à quelqu'un : « Qu'est-ce que tu as fait aujourd'hui ? » et réponds aussi pour toi-même.", promptEn: "Ask someone: « Qu'est-ce que tu as fait aujourd'hui ? » and answer for yourself too." },
  24: { grammar: "Verbes avec être au passé composé : aller, venir", vocab: "repas, dîner, déjeuner, courses, faire les courses", vocabWords: ["repas/dîner/déjeuner", "courses", "faire les courses"], vocabExamples: [["Je suis allé faire les courses ce matin.", "I went grocery shopping this morning."], ["Tu es allée au déjeuner en famille ?", "Did you go to the family lunch?"], ["Il est venu pour le dîner.", "He came for dinner."], ["Elle est venue préparer le repas.", "She came to prepare the meal."], ["Nous sommes allés au déjeuner ensemble.", "We went to lunch together."], ["Ils sont venus pour le repas du soir.", "They came for the evening meal."]], didYouNotice: "A small group of verbs (mostly movement, like aller and venir) use être instead of avoir as the helper. With these, the participle behaves like an adjective and agrees with the subject: il est allé, elle est allée, ils sont allés, elles sont allées. This agreement never happens with avoir-verbs — avoir-verbs' participles stay fixed no matter who the subject is.", tables: [{ title: "Passé composé avec être (verbes de mouvement)", rows: CONJUGATIONS.etre.rows, note: "Le participe s'accorde : il est allé / elle est allée." }], participleLesson: { intro: "Aller and venir use être as their helper instead of avoir, because they're verbs of movement. Like avoir-verbs, the participle is never the infinitive — but with être-verbs, the participle also changes spelling to agree with the subject.", pairs: [["aller", "allé(e)", "to go"], ["venir", "venu(e)", "to come"]], rule: "Passé composé = être (conjugué) + participe passé", helperExamples: [["je suis", "allé(e)"], ["tu es", "allé(e)"], ["il est", "allé"]], examplePairs: [["Je suis allé(e).", "Je suis aller."]] }, prompt: "Raconte où tu es allé(e) et qui est venu te voir récemment : « Je suis allé(e)... », « Il/elle est venu(e)... ».", promptEn: "Talk about where you went and who came to see you recently: « Je suis allé(e)... », « Il/elle est venu(e)... »." },
  25: { grammar: "Verbes avec être : arriver, partir", vocab: "ranger, nettoyer, rentrer", vocabWords: ["ranger", "nettoyer", "rentrer"], vocabExamples: [["Je suis arrivé tôt aujourd'hui.", "I arrived early today."], ["Tu es partie sans dire au revoir ?", "You left without saying goodbye?"], ["Il est arrivé tard ce soir.", "He arrived late tonight."], ["Elle est partie tôt ce matin.", "She left early this morning."], ["Nous sommes arrivés ensemble.", "We arrived together."], ["Ils sont partis avant le dîner.", "They left before dinner."], ["Je suis rentré tard, j'ai rangé la maison avant.", "I came home late, I tidied the house before that."]], tables: [{ title: "Passé composé avec être (verbes de mouvement)", rows: CONJUGATIONS.etre.rows, note: "Exemples : je suis arrivé(e), tu es parti(e)." }], participleLesson: { intro: "Arriver and partir also use être as their helper. Same two rules as Day 24: the participle is never the infinitive, and it agrees with the subject.", pairs: [["arriver", "arrivé(e)", "to arrive"], ["partir", "parti(e)", "to leave"]], rule: "Passé composé = être (conjugué) + participe passé", helperExamples: [["je suis", "arrivé(e)"], ["tu es", "parti(e)"], ["il est", "arrivé"]], examplePairs: [["Je suis arrivé(e).", "Je suis arriver."], ["Tu es parti(e).", "Tu es partir."]] }, prompt: "Raconte à quelle heure tu es arrivé(e) et parti(e) aujourd'hui.", promptEn: "Say what time you arrived and left today." },
  26: { grammar: "Révision : aller, venir, arriver, partir", vocab: "voyage, vacances, rendez-vous, projet", vocabWords: ["voyage/vacances", "rendez-vous", "projet"], vocabExamples: [["Je suis allé en voyage récemment.", "I went on a trip recently."], ["Tu es venu pour les vacances ?", "Did you come for the holidays?"], ["Il est arrivé pour son rendez-vous.", "He arrived for his appointment."], ["Elle est partie pour un nouveau projet.", "She left for a new project."], ["Nous sommes allés en vacances ensemble.", "We went on vacation together."], ["Ils sont venus discuter du projet.", "They came to discuss the project."]], tables: [{ title: "Passé composé avec être (verbes de mouvement)", rows: CONJUGATIONS.etre.rows }], prompt: "Raconte ta journée en quatre phrases avec aller, venir, arriver et partir.", promptEn: "Tell your day in four sentences using aller, venir, arriver, and partir." },
  27: { grammar: "Verbes avec être : rester, sortir", vocab: "problème, solution", vocabWords: ["problème", "solution"], vocabExamples: [["Je suis resté à la maison à cause d'un problème.", "I stayed home because of a problem."], ["Tu es sorti trouver une solution ?", "Did you go out to find a solution?"], ["Il est resté toute la soirée.", "He stayed all evening."], ["Elle est sortie chercher une solution.", "She went out to look for a solution."], ["Nous sommes restés ensemble pendant le problème.", "We stayed together during the problem."], ["Ils sont sortis fêter la solution.", "They went out to celebrate the solution."]], tables: [{ title: "Passé composé avec être (verbes de mouvement)", rows: CONJUGATIONS.etre.rows, note: "Exemples : je suis resté(e), tu es sorti(e)." }], participleLesson: { intro: "Rester and sortir round out this group of être-verbs. Same two rules apply: the participle is never the infinitive, and it agrees with the subject.", pairs: [["rester", "resté(e)", "to stay"], ["sortir", "sorti(e)", "to go out"]], rule: "Passé composé = être (conjugué) + participe passé", helperExamples: [["je suis", "resté(e)"], ["tu es", "sorti(e)"], ["il est", "resté"]], examplePairs: [["Je suis resté(e).", "Je suis rester."], ["Tu es sorti(e).", "Tu es sortir."]] }, prompt: "Dis si tu es resté(e) à la maison ou si tu es sorti(e) ce week-end.", promptEn: "Say whether you stayed home or went out this weekend." },
  28: { grammar: "Révision complète des verbes avec être — l'accord", vocab: "Révision vie quotidienne", vocabWords: [], tables: [{ title: "Passé composé avec être — accord", rows: CONJUGATIONS.etre.rows, note: "elle est allée / ils sont sortis / elles sont parties." }], prompt: "Raconte la journée de quelqu'un d'autre (il/elle) — fais attention à l'accord : « elle est allée », « ils sont sortis ».", promptEn: "Tell someone else's day (il/elle) — watch the agreement: « elle est allée », « ils sont sortis »." },
  29: { grammar: "Mélange avoir + être au passé composé", vocab: "Révision vie quotidienne", vocabWords: [], tables: [CONJUGATIONS.avoir, CONJUGATIONS.etre], prompt: "Raconte ta journée en mélangeant avoir et être : « Je suis allé(e) au travail, j'ai mangé, puis je suis rentré(e). »", promptEn: "Tell your day mixing avoir and être: « Je suis allé(e) au travail, j'ai mangé, puis je suis rentré(e). »" },
  30: { grammar: "Connecteurs de récit : puis, ensuite, alors", vocab: "Révision vie quotidienne", vocabWords: ["puis", "ensuite", "alors"], vocabExamples: [["J'ai mangé, puis je suis sorti.", "I ate, then I went out."], ["Je suis rentré, ensuite j'ai dormi.", "I came home, then I slept."], ["J'ai eu faim, alors j'ai mangé.", "I got hungry, so I ate."]], tables: [CONJUGATIONS.avoir, CONJUGATIONS.etre], prompt: "Raconte ta journée en reliant les phrases avec puis, ensuite, alors.", promptEn: "Tell your day, linking your sentences with puis, ensuite, alors." },
  31: { grammar: "Révision libre du bloc", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.avoir, CONJUGATIONS.etre], prompt: "Réécoute ta phrase du Jour 21 et améliore-la.", promptEn: "Listen back to your Day 21 sentence and improve it." },
  32: { grammar: "Jour de parole : raconte ta journée d'hier en détail", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.avoir, CONJUGATIONS.etre], prompt: "Raconte ta journée d'hier en détail, à voix haute, une minute minimum.", promptEn: "Tell yesterday's day in detail, out loud, one minute minimum." },
  33: { grammar: "Jour de parole : raconte un événement familial récent", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.avoir, CONJUGATIONS.etre], prompt: "Raconte un événement familial récent en quatre ou cinq phrases au passé composé.", promptEn: "Tell a recent family event in four or five sentences using passé composé." },
  34: { grammar: "Révision des points faibles identifiés", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.avoir, CONJUGATIONS.etre], prompt: "Reprends les verbes du passé composé qui te bloquent encore et répète-les trois fois chacun.", promptEn: "Go back over the passé composé verbs that still trip you up and repeat each three times." },
  35: { grammar: "Checkpoint du bloc : monologue de 2 min entièrement au passé composé", vocab: "Révision de tout le bloc 3", vocabWords: [], tables: [CONJUGATIONS.avoir, CONJUGATIONS.etre], prompt: "Enregistre un monologue de deux minutes entièrement au passé composé.", promptEn: "Record a two-minute monologue entirely in the passé composé." },

  36: { grammar: "Futur proche : aller + infinitif", vocab: "manger, boire, café, eau", vocabWords: ["manger", "boire", "café", "eau"], vocabExamples: [["Je vais manger bientôt.", "I'm going to eat soon."], ["Tu vas boire un café ?", "Are you going to have a coffee?"], ["Il va boire de l'eau.", "He's going to drink water."], ["Elle va manger avec nous.", "She's going to eat with us."], ["On va prendre un café.", "We're going to have a coffee."], ["Vous allez manger bientôt ?", "Are you going to eat soon?"], ["Ils vont prendre de l'eau.", "They're going to get some water."]], tables: [{ title: "Futur proche = aller (conjugué) + infinitif", rows: CONJUGATIONS.aller.rows, note: "Exemple : je vais manger, tu vas sortir, ils vont rester." }], prompt: "Dis ce que tu vas faire avec aller + infinitif : « Je vais... », « Tu vas... », « Il/elle va... ».", promptEn: "Say what you're going to do using aller + infinitive: « Je vais... », « Tu vas... », « Il/elle va... »." },
  37: { grammar: "Futur proche — pratique : parler de cette semaine", vocab: "restaurant, inviter, fête, anniversaire, cadeau", vocabWords: ["restaurant", "inviter", "fête", "anniversaire", "cadeau"], vocabExamples: [["On va aller au restaurant.", "We're going to go to the restaurant."], ["Je vais inviter mes amis.", "I'm going to invite my friends."], ["Il va organiser une fête samedi.", "He's going to throw a party Saturday."], ["On va fêter mon anniversaire demain.", "We're going to celebrate my birthday tomorrow."], ["Je vais t'apporter un cadeau.", "I'm going to bring you a gift."]], tables: [{ title: "Futur proche = aller (conjugué) + infinitif", rows: CONJUGATIONS.aller.rows }], prompt: "Dis trois choses que tu vas faire cette semaine.", promptEn: "Say three things you're going to do this week." },
  38: { grammar: "Révision futur proche", vocab: "Révision nourriture & social", vocabWords: [], tables: [{ title: "Futur proche = aller (conjugué) + infinitif", rows: CONJUGATIONS.aller.rows }], prompt: "Demande à quelqu'un : « Qu'est-ce que tu vas faire ce week-end ? »", promptEn: "Ask someone: « Qu'est-ce que tu vas faire ce week-end ? »" },
  39: { grammar: "Impératif — formes « tu » (viens, attends, dis-moi, fais)", vocab: "boire un verre, cuisiner, recette, plat, dessert", vocabWords: ["boire un verre", "cuisiner", "recette", "plat", "dessert"], vocabExamples: [["Viens boire un verre avec moi !", "Come have a drink with me!"], ["Attends, je cuisine le dessert !", "Wait, I'm cooking the dessert!"], ["Dis-moi la recette du plat !", "Tell me the recipe for the dish!"], ["Fais un bon plat pour ce soir !", "Make a good dish for tonight!"]], tables: [CONJUGATIONS.impTu], prompt: "Donne trois ordres ou demandes avec l'impératif : « Viens ! », « Attends ! », « Dis-moi ! ».", promptEn: "Give three commands or requests using the imperative: « Viens ! », « Attends ! », « Dis-moi ! »." },
  40: { grammar: "Impératif — formes « nous/vous » (allons-y, venez)", vocab: "santé, bon appétit, trinquer, partager un repas", vocabWords: ["santé", "bon appétit", "trinquer", "partager un repas"], vocabExamples: [["Santé ! Trinquons ensemble !", "Cheers! Let's toast together!"], ["Bon appétit ! Partageons ce repas !", "Enjoy your meal! Let's share this meal!"], ["Venez, on va trinquer !", "Come, let's toast!"], ["Allons-y, le repas est prêt !", "Let's go, the meal is ready!"]], tables: [CONJUGATIONS.impNousVous], prompt: "Utilise « Allons-y ! » et « Venez ! » dans une situation imaginée.", promptEn: "Use « Allons-y ! » and « Venez ! » in an imagined situation." },
  41: { grammar: "Révision impératif", vocab: "Révision nourriture & social", vocabWords: [], tables: [CONJUGATIONS.impTu, CONJUGATIONS.impNousVous], prompt: "Pratique cinq demandes que tu dirais vraiment à la maison, à l'impératif.", promptEn: "Practice five requests you'd actually make at home, using the imperative." },
  42: { grammar: "venir de + infinitif (passé récent) — introduction", vocab: "Révision : rendez-vous, projet", vocabWords: [], tables: [{ title: "venir de + infinitif (passé récent)", rows: CONJUGATIONS.venir.rows, note: "Exemple : je viens de manger, tu viens de partir." }], prompt: "Dis ce que tu viens de faire : « Je viens de... », « Tu viens de... ».", promptEn: "Say what you just did: « Je viens de... », « Tu viens de... »." },
  43: { grammar: "venir de + infinitif — pratique", vocab: "Révision libre", vocabWords: [], tables: [{ title: "venir de + infinitif (passé récent)", rows: CONJUGATIONS.venir.rows }], prompt: "Dis trois choses que tu viens de faire aujourd'hui.", promptEn: "Say three things you just did today." },
  44: { grammar: "Révision : venir de + futur proche ensemble", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.aller, CONJUGATIONS.venir], prompt: "Combine les deux dans une phrase : « Je viens de... et je vais... ».", promptEn: "Combine both in one sentence: « Je viens de... et je vais... »." },
  45: { grammar: "Mélange : projets + actions récentes + demandes", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.aller, CONJUGATIONS.venir, CONJUGATIONS.impTu], prompt: "Raconte un plan : ce que tu viens de faire, ce que tu vas faire, et une demande à quelqu'un.", promptEn: "Tell a plan: what you just did, what you're about to do, and a request to someone." },
  46: { grammar: "Jour de parole : fais des projets pour le week-end à voix haute", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.aller], prompt: "Fais des projets pour le week-end à voix haute, avec aller + infinitif.", promptEn: "Make weekend plans out loud, using aller + infinitive." },
  47: { grammar: "Jour de parole : 5 vraies demandes que tu dirais à la maison", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.impTu, CONJUGATIONS.impNousVous], prompt: "Dis cinq vraies demandes que tu dirais à la maison, à l'impératif.", promptEn: "Say five real requests you'd make at home, using the imperative." },
  48: { grammar: "Révision des points faibles", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.aller, CONJUGATIONS.venir, CONJUGATIONS.impTu], prompt: "Reprends ce qui te bloque encore dans ce bloc et répète-le.", promptEn: "Go back over what still trips you up in this block and repeat it." },
  49: { grammar: "Intègre tout le bloc dans un dialogue court", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.aller, CONJUGATIONS.venir, CONJUGATIONS.impTu, CONJUGATIONS.impNousVous], prompt: "Imagine un court dialogue avec futur proche, impératif et venir de.", promptEn: "Imagine a short dialogue using futur proche, imperative, and venir de." },
  50: { grammar: "Checkpoint du bloc : monologue de 2 min avec futur proche, impératif, venir de", vocab: "Révision de tout le bloc 4", vocabWords: [], tables: [CONJUGATIONS.aller, CONJUGATIONS.venir, CONJUGATIONS.impTu], prompt: "Enregistre un monologue de deux minutes avec futur proche, impératif et venir de.", promptEn: "Record a two-minute monologue using futur proche, imperative, and venir de." },

  51: { grammar: "je voudrais / j'aimerais", vocab: "Révision émotions & opinions", vocabWords: [], tables: [CONJUGATIONS.condChunks], prompt: "Utilise « je voudrais » et « j'aimerais » dans deux phrases sur ce que tu veux faire bientôt.", promptEn: "Use « je voudrais » and « j'aimerais » in two sentences about what you want to do soon." },
  52: { grammar: "tu pourrais / est-ce que tu pourrais", vocab: "Révision émotions & opinions", vocabWords: [], tables: [CONJUGATIONS.condChunks], prompt: "Transforme une demande directe en demande adoucie : « Fais ça » → « Tu pourrais faire ça ? ».", promptEn: "Turn a direct request into a softened one: « Fais ça » → « Tu pourrais faire ça ? »." },
  53: { grammar: "ça serait + révision des formules d'adoucissement", vocab: "d'accord, pas d'accord, sûr(e), peut-être", vocabWords: ["sûr(e)", "peut-être"], vocabExamples: [["Ça serait bien de se voir bientôt.", "It would be nice to see each other soon."], ["Je suis sûr que ça serait une bonne idée.", "I'm sure that would be a good idea."], ["Peut-être que ça serait plus simple comme ça.", "Maybe it would be simpler that way."], ["Ça serait sympa de manger ensemble.", "It would be nice to eat together."]], tables: [CONJUGATIONS.condChunks], prompt: "Utilise « ça serait » dans une phrase : « Ça serait bien de... ».", promptEn: "Use « ça serait » in a sentence: « Ça serait bien de... »." },
  54: { grammar: "Désaccord & réparation : pas d'accord, ce n'est pas grave, on peut en parler", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.condChunks], prompt: "Pratique : « Je ne suis pas d'accord, mais... » suivi de « Ce n'est pas grave » ou « On peut en parler ».", promptEn: "Practice: « Je ne suis pas d'accord, mais... » followed by « Ce n'est pas grave » or « On peut en parler »." },
  55: { grammar: "Checkpoint du bloc : adoucis 3 demandes réelles + 1 désaccord", vocab: "Révision de tout le bloc 5", vocabWords: [], tables: [CONJUGATIONS.condChunks], prompt: "Adoucis trois demandes réelles et pratique un désaccord avec réparation.", promptEn: "Soften three real requests and practice a disagreement with repair." },

  56: { grammar: "Bilan (1/2) — monologue intégrant présent, passé composé, futur proche, conditionnel + réparation ciblée des points faibles", vocab: "Révision générale", vocabWords: [], tables: [], prompt: "Enregistre un monologue de deux minutes intégrant présent, passé composé, futur proche et une formule au conditionnel. Puis réécoute ton enregistrement du Jour 20 — qu'est-ce qui a changé depuis ? Reprends les trois points qui te bloquent encore.", promptEn: "Record a two-minute monologue combining présent, passé composé, futur proche, and one conditionnel phrase. Then listen back to your Day 20 recording — what's changed since then? Go back over the three points that still trip you up." },
  57: { grammar: "Bilan (2/2) — vraie conversation de 10+ minutes, sans anglais pendant les 5 premières minutes", vocab: "Révision générale", vocabWords: [], tables: [], prompt: "Vraie conversation de dix minutes ou plus, sans anglais pendant les cinq premières minutes.", promptEn: "Have a real conversation, ten minutes or more, with no English for the first five minutes." },

  58: { grammar: "Formation de l'imparfait — verbes en -er (radical de « nous » au présent + terminaisons)", vocab: "Souvenirs : enfance, autrefois, à l'époque", vocabWords: ["enfance", "autrefois", "à l'époque"], vocabExamples: [["Autrefois, je parlais moins.", "Before, I used to talk less."], ["À l'époque, tu habitais où ?", "Back then, where did you live?"], ["Dans mon enfance, on mangeait ensemble tous les soirs.", "In my childhood, we ate together every evening."]], didYouNotice: "The imparfait is built from the present-tense « nous » stem (nous parl-ons → parl-), never from the infinitive. The endings -ais/-ais/-ait/-ions/-iez/-aient are the same for almost every verb in French.", tables: [CONJUGATIONS.imparfaitTerminaisons, CONJUGATIONS.parlerImparfait], prompt: "Raconte trois choses que tu faisais souvent, à l'imparfait : « Je parlais... », « Tu habitais... ».", promptEn: "Say three things you used to do often, using the imparfait: « Je parlais... », « Tu habitais... »." },
  59: { grammar: "Imparfait — verbes en -ir/-re et radical irrégulier à l'oral (faire → fais-)", vocab: "Habitudes : d'habitude, chaque jour, tout le temps", vocabWords: ["d'habitude", "chaque jour", "tout le temps"], vocabExamples: [["D'habitude, je finissais tôt.", "Usually, I used to finish early."], ["Chaque jour, tu faisais du sport.", "Every day, you used to exercise."], ["Tout le temps, on avait faim après l'école.", "All the time, we were hungry after school."]], tables: [CONJUGATIONS.imparfaitTerminaisons, CONJUGATIONS.finirImparfait, CONJUGATIONS.faireImparfait, CONJUGATIONS.avoirImparfait], prompt: "Utilise finir, faire et avoir à l'imparfait dans trois phrases sur tes habitudes d'avant.", promptEn: "Use finir, faire, and avoir in the imparfait in three sentences about your past habits." },
  60: { grammar: "Imparfait irrégulier : être (ét-)", vocab: "Révision : émotions, descripteurs", vocabWords: [], vocabExamples: [["J'étais content(e) à l'époque.", "I was happy back then."], ["Tu étais jeune quand tu es arrivé(e) ici.", "You were young when you arrived here."], ["Nous étions toujours ensemble.", "We were always together."]], didYouNotice: "« être » is the only verb whose imparfait stem isn't predictable (ét-, not « êt- »). That's why it gets learned on its own — once you know it, every other verb in the imparfait follows the regular rule.", tables: [CONJUGATIONS.etreImparfait], prompt: "Décris comment tu étais il y a dix ans, en trois phrases avec être à l'imparfait.", promptEn: "Describe what you were like ten years ago, in three sentences using être in the imparfait." },
  61: { grammar: "Usage 1 — décrire une scène du passé (temps, lieu, état physique/émotionnel)", vocab: "Météo : il faisait beau/froid/chaud, il pleuvait", vocabWords: ["il faisait beau/froid/chaud", "il pleuvait"], vocabExamples: [["Il faisait beau, et j'étais heureux.", "The weather was nice, and I was happy."], ["Il pleuvait, alors on restait à la maison.", "It was raining, so we stayed home."], ["C'était calme, tout le monde dormait encore.", "It was quiet, everyone was still asleep."]], tables: [CONJUGATIONS.etreImparfait, CONJUGATIONS.avoirImparfait], prompt: "Décris une scène du passé : le temps qu'il faisait, où tu étais, comment tu te sentais — tout à l'imparfait.", promptEn: "Describe a scene from the past: what the weather was like, where you were, how you felt — all in the imparfait." },
  62: { grammar: "Usage 2 — actions habituelles ou répétées dans le passé", vocab: "Fréquence au passé : souvent, toujours, tous les jours", vocabWords: [], vocabExamples: [["Quand j'étais petit(e), je jouais dehors tous les jours.", "When I was little, I played outside every day."], ["On allait chez mes grands-parents chaque dimanche.", "We used to go to my grandparents' every Sunday."], ["Tu prenais toujours le même chemin.", "You always used to take the same route."]], tables: [CONJUGATIONS.parlerImparfait, CONJUGATIONS.faireImparfait], prompt: "Quand tu étais enfant, qu'est-ce que tu faisais souvent ? Donne au moins trois habitudes à l'imparfait.", promptEn: "When you were a child, what did you often do? Give at least three habits using the imparfait." },
  63: { grammar: "Révision : formation + description + habitude", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.imparfaitTerminaisons, CONJUGATIONS.etreImparfait, CONJUGATIONS.avoirImparfait], prompt: "Décris ta vie il y a cinq ans : où tu habitais, ce que tu faisais d'habitude, comment tu étais.", promptEn: "Describe your life five years ago: where you lived, what you usually did, what you were like." },
  64: { grammar: "Usage 3 — action interrompue : imparfait (toile de fond) + passé composé (événement)", vocab: "quand, pendant que", vocabWords: ["quand", "pendant que"], vocabExamples: [["Je dormais quand le téléphone a sonné.", "I was sleeping when the phone rang."], ["On mangeait quand tu es arrivé(e).", "We were eating when you arrived."], ["Il faisait ses devoirs pendant que sa sœur regardait la télé.", "He was doing homework while his sister was watching TV."]], didYouNotice: "This is the heart of French storytelling: the imparfait sets the scene (what was already going on), and the passé composé brings in the event that interrupts or moves the story forward. The two always work together, never in competition.", tables: [CONJUGATIONS.etreImparfait, { title: "Passé composé (rappel)", rows: CONJUGATIONS.avoir.rows }], prompt: "Raconte une interruption : « Je faisais X quand Y s'est passé. » Fais-en trois.", promptEn: "Tell an interruption: « Je faisais X quand Y s'est passé. » Make three of them." },
  65: { grammar: "Contraste intensif : passé composé vs imparfait", vocab: "Révision libre", vocabWords: [], vocabExamples: [["Hier, j'ai mangé à midi. (événement ponctuel)", "Yesterday, I ate at noon. (single event)"], ["Avant, je mangeais toujours à midi. (habitude)", "Before, I always used to eat at noon. (habit)"], ["Je lisais quand tu as appelé. (toile de fond + événement)", "I was reading when you called. (backdrop + event)"]], tables: [CONJUGATIONS.parlerImparfait], prompt: "Pour chaque phrase, choisis passé composé ou imparfait et justifie ton choix à voix haute — invente cinq exemples.", promptEn: "For each sentence, choose passé composé or imparfait and justify your choice out loud — make up five examples." },
  66: { grammar: "Jour de parole : raconte un souvenir d'enfance", vocab: "Révision libre", vocabWords: [], tables: [], prompt: "Raconte un souvenir d'enfance en mélangeant imparfait (description, habitudes) et passé composé (ce qui s'est passé), une minute minimum.", promptEn: "Tell a childhood memory, mixing imparfait (description, habits) and passé composé (what happened), one minute minimum." },
  67: { grammar: "Révision des points faibles identifiés", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.imparfaitTerminaisons, CONJUGATIONS.etreImparfait], prompt: "Reprends ce qui te bloque encore entre passé composé et imparfait, et répète-le trois fois.", promptEn: "Go back over what still trips you up between passé composé and imparfait, and repeat it three times." },
  68: { grammar: "Checkpoint du bloc : monologue de 3 minutes avec narration complète (imparfait + passé composé)", vocab: "Révision de tout le bloc 7", vocabWords: [], tables: [], prompt: "Enregistre un monologue de trois minutes racontant une histoire complète — plante le décor à l'imparfait, fais avancer l'action au passé composé.", promptEn: "Record a three-minute monologue telling a complete story — set the scene in the imparfait, move the action forward in the passé composé." },

  69: { grammar: "Bilan final (1/2) — test de compréhension : lecture des 5 chapitres de l'histoire", vocab: "Révision générale", vocabWords: [], tables: [], prompt: "Summarize the story of Élise in your own words: what happens in each chapter? What lessons does she learn?", chapters: [
  ...
  70: { grammar: "Bilan final (2/2) — test de fluidité : conversation et monologue final", vocab: "Révision générale", vocabWords: [], tables: [], prompt: "Vraie conversation de dix minutes ou plus sur l'histoire d'Élise, sans anglais. Puis un monologue final — compare-le au tout premier jour.", promptEn: "Have a real conversation, ten minutes or more, about Élise's story, with no English. Then record a final monologue — compare it to your very first day." }
};
