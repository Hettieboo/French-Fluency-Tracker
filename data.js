...
const CONJUGATIONS = {
  ...
  imparfaitTerminaisons: { title: "Terminaisons de l'imparfait (tous les verbes, sauf être)", rows: [["je", "-ais"], ["tu", "-ais"], ["il / elle / on", "-ait"], ["nous", "-ions"], ["vous", "-iez"], ["ils / elles", "-aient"]], note: "The radical (stem) is the present-tense « nous » form minus -ons. E.g. nous parlons → parl-, nous finissons → finiss-, nous faisons → fais-." },
  ...
  faireImparfait: { title: "faire (imparfait)", rows: [["je", "faisais"], ["tu", "faisais"], ["il / elle / on", "faisait"], ["nous", "faisions"], ["vous", "faisiez"], ["ils / elles", "faisaient"]], note: "The spoken stem (fais-) looks irregular, but the endings themselves are completely regular." },
  avoirImparfait: { title: "avoir (imparfait)", rows: [["j'", "avais"], ["tu", "avais"], ["il / elle / on", "avait"], ["nous", "avions"], ["vous", "aviez"], ["ils / elles", "avaient"]] },
  etreImparfait: { title: "être (imparfait)", rows: [["j'", "étais"], ["tu", "étais"], ["il / elle / on", "était"], ["nous", "étions"], ["vous", "étiez"], ["ils / elles", "étaient"]], note: "The only truly irregular stem in the imparfait: ét-. The endings themselves stay identical to every other verb." }
};
...
const DAY_DETAILS = {
  ...
  67: { grammar: "Jour de parole : relis un chapitre de l'histoire et repère l'imparfait", vocab: "Révision libre", vocabWords: [], tables: [], prompt: "Relis un des chapitres ci-dessous et repère tous les verbes à l'imparfait — dis pourquoi chacun est à l'imparfait et pas au passé composé. Compare avec ta première lecture aux Jours 56-57 : qu'est-ce que tu comprends mieux maintenant ?", chapters: [
    { n: 1, file: "chapter-1.html", title: "Un nouveau départ" },
    { n: 2, file: "chapter-2.html", title: "Dans la cuisine de Marie" },
    { n: 3, file: "chapter-3.html", title: "Les courses" },
    { n: 4, file: "chapter-4.html", title: "Chez les grands-parents" },
